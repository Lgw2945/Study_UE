...
#include "CH3_2/Public/MyGameState.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyGameState() {}

// Begin Cross Module References
CH3_2_API UClass* Z_Construct_UClass_AMyGameState();
CH3_2_API UClass* Z_Construct_UClass_AMyGameState_NoRegister();
...
// Begin Class AMyGameState Function AddWave
struct Z_Construct_UFunction_AMyGameState_AddWave_Statics
{
	struct MyGameState_eventAddWave_Parms
	{
		int32 Amount;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AMyGameState_AddWave_Statics::NewProp_Amount = { "Amount", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyGameState_eventAddWave_Parms, Amount), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMyGameState_AddWave_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMyGameState_AddWave_Statics::NewProp_Amount,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyGameState_AddWave_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyGameState_AddWave_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMyGameState, nullptr, "AddWave", nullptr, nullptr, Z_Construct_UFunction_AMyGameState_AddWave_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMyGameState_AddWave_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMyGameState_AddWave_Statics::MyGameState_eventAddWave_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyGameState_AddWave_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyGameState_AddWave_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AMyGameState_AddWave_Statics::MyGameState_eventAddWave_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AMyGameState_AddWave()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMyGameState_AddWave_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMyGameState::execAddWave)
{
	P_GET_PROPERTY(FIntProperty,Z_Param_Amount);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->AddWave(Z_Param_Amount);
	P_NATIVE_END;
}
// End Class AMyGameState Function AddWave
...
void AMyGameState::StaticRegisterNativesAMyGameState()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "AddWave", &AMyGameState::execAddWave },
...
struct Z_Construct_UClass_AMyGameState_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AMyGameState_AddWave, "AddWave" }, // 879609890
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AMyGameState_Statics::NewProp_ItemWave = { "ItemWave", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyGameState, ItemWave), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ItemWave_MetaData), NewProp_ItemWave_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AMyGameState_Statics::NewProp_AddWaveItem = { "AddWaveItem", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyGameState, AddWaveItem), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AddWaveItem_MetaData), NewProp_AddWaveItem_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMyGameState_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyGameState_Statics::NewProp_ItemWave,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyGameState_Statics::NewProp_AddWaveItem,
};
...
template<> CH3_2_API UClass* StaticClass<AMyGameState>()
{
	return AMyGameState::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_USER_Documents_Unreal_Projects_CH3_2_Source_CH3_2_Public_MyGameState_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyGameState, AMyGameState::StaticClass, TEXT("AMyGameState"), &Z_Registration_Info_UClass_AMyGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyGameState), 2009281601U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_USER_Documents_Unreal_Projects_CH3_2_Source_CH3_2_Public_MyGameState_h_832466103(TEXT("/Script/CH3_2"),
	Z_CompiledInDeferFile_FID_Users_USER_Documents_Unreal_Projects_CH3_2_Source_CH3_2_Public_MyGameState_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_USER_Documents_Unreal_Projects_CH3_2_Source_CH3_2_Public_MyGameState_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
